...
> [!NOTE]
C is often called the **mother of modern programming languages** because many languages such as C++, Java, C#, Objective-C, PHP and even Python were influenced by its syntax and concepts.
...
> [!TIP]
If you understand C well, learning C++, Java, Python and many other languages becomes much easier because their syntax and programming concepts are similar.
...
| Feature | Description |
|---------|-------------|
| General Purpose | Suitable for almost every type of software development. |
| Portable | Programs can run on different operating systems with minimal changes. |
| Fast Execution | Compiled directly into machine code for high performance. |
| Structured Programming | Programs can be divided into reusable functions. |
| Rich Standard Library | Includes many built-in functions for input, output, strings and files. |
| Memory Access | Allows direct memory manipulation using pointers. |
| Modular | Large applications can be divided into multiple files and functions. |
...
> [!WARNING]
Since C gives programmers direct access to memory, even a small mistake can cause unexpected program crashes. Always write and test your programs carefully.
...
> [!IMPORTANT]
Every valid C program must contain exactly one `main()` function because execution always begins there.
...
> [!TIP]
Programming is learned by writing code, not just by reading theory. Try modifying every example inside the KauraC Compiler.
